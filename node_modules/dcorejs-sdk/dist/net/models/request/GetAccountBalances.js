...
var GetAccountBalances = /** @class */ (function (_super) {
    ...
    function GetAccountBalances(accountId, assets) {
        if (assets === void 0) { assets = []; }
        var _this = _super.call(this, ApiGroup_1.ApiGroup.Database, "get_account_balances", [accountId.objectId, assets.map(function (value) { return value.objectId; })], function (value) { return class_transformer_1.plainToClass(AssetAmount_1.AssetAmount, value); }) || this;
